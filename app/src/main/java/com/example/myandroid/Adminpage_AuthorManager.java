...
public class Adminpage_AuthorManager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Author> author_list_array = new ArrayList<>();
        Update_delete_event(author_list_array);
        Adminpage_AuthorManager_Author_list_adapter adapter = new Adminpage_AuthorManager_Author_list_adapter(author_list_array,listenner);
